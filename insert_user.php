...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		values('$first_name','$last_name','$username','Hello FriendSpace.This is default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
