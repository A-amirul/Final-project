				...
				<div class="l_pass">
					<form action="" method="POST">
						<div class="input-group">
							...
							<input id="password" class="form-control" type="password" name="pass" placeholder="Enter New Password" required>
						</div><br>

						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
							<input id="password" class="form-control" type="password" name="pass1" placeholder="Confirm New Password" required>
						</div><br>
