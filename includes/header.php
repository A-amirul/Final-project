...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="home.php">FriendSpace</a>
		</div>
			...
			<li><a href="messages.php?u_id=new">Messages</a></li>
					...
					<?php
						...
						<li class='dropdown'>
							...
							<a href='#' class='dropdown-toggle' data-toggle='dropdown' aria-expanded='false'><span><i class='glyphicon glyphicon-chevron-down'></i></span></a>
