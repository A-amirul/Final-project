...
<body>
	<div class="row">
		...
		<div class="col-sm-12">
						...
						<center>
							<div style='background-color: #e6e6e6;' class='col-sm-3'>
								...
								<ul class='list-group'>
									...
									<li class='list-group-item' title='Status'><strong style='color: grey;'>$describe_user</strong></li>
			...
			<div class="col-sm-7">
				<center><h1><strong><?php echo "$f_name $l_name All Posts";?></strong></h1></center>
